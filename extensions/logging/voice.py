...
class VoiceLogs(LoggingBase):
    ...
    async def logging_on_voice_state_update(self, member: discord.Member, before: discord.VoiceState, after: discord.VoiceState):
        ...
        if before.channel and after.channel and before.channel != after.channel and self.bot.guild_loggings[member.guild.id].voice_move:
            embed = discord.Embed(
                ...
                description=f"**From:** {before.channel.mention} ({after.channel.id})" f"\n**To:** {after.channel.mention} ({after.channel.id})",
            )
    ...
    async def logging_on_stage_instance_create(self, stage_instance: discord.StageInstance):
    ...
    async def logging_on_stage_instance_delete(self, stage_instance: discord.StageInstance):
    ...
    async def logging_on_stage_instance_update(self, before: discord.StageInstance, after: discord.StageInstance):
        pass
