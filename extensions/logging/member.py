...
class MemberLogs(LoggingBase):
    ...
    async def logging_on_member_update(self, before: discord.Member, after: discord.Member):
        ...
        if before.avatar != after.avatar:
            if after.avatar is not None:
                ...
                embed.set_thumbnail(url=after.guild_avatar.url) # type: ignore
    ...
    async def logging_on_user_update(self, before: discord.User, after: discord.User):
    ...
    async def logging_on_member_ban(self, guild: discord.Guild, user: discord.User):
    ...
    async def logging_on_member_unban(self, guild: discord.Guild, user: discord.User):
