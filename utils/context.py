...
from utils import constants, tick
...
class Confirm(discord.ui.View):
    def __init__(self, buttons: typing.Tuple[typing.Tuple[str]], timeout: int = 30):
        ...
        self.add_item(CancelButton(emoji=buttons[1][0], label=buttons[1][1], button_style=(buttons[1][2] or discord.ButtonStyle.red)))
...
class CustomContext(commands.Context):
    ...
    async def confirm(
        ...
        view = Confirm(buttons=buttons or ((None, "Confirm", discord.ButtonStyle.green), (None, "Cancel", discord.ButtonStyle.red)), timeout=timeout)
        view.ctx = self
