...
class WelcomeView(discord.ui.View):
    ...
    async def rules(self, interaction: discord.Interaction, button: discord.ui.Button):
        embed = Embed(
            ...
            description="` 01. ` Be respectful and kind to all members of the server.\n"
                        ...
                        "` 05. ` Do not share personal information or private messages without consent.\n"
                        ...
                        "` 09. ` Keep discussions and conversations appropriate for the designed channels.\n"
    ...
    @discord.ui.button(label="Reaction Roles", emoji="🎭", style=discord.ButtonStyle.blurple, custom_id="world:reaction_roles")
